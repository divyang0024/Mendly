...
export default function ProfileCard() {
  ...
  const domEmoji = dominant ? emotionEmoji[dominant[0]] : "✨";
  const maxPct = dominant ? dominant[1] : 1;
  ...
  return (
    <>
      <style>{`
        ...
        :root{--primary:#4C662B;--primary-container:#CDEDA3;--on-primary:#FFFFFF;--on-primary-container:#354E16;--secondary:#586249;--secondary-container:#DCE7C8;--on-secondary-container:#404A33;--tertiary:#386663;--tertiary-container:#BCECE7;--on-tertiary-container:#1F4E4B;--on-surface:#1A1C16;--on-surface-variant:#44483D;--outline:#75796C;--outline-variant:#C5C8BA;--surface-container-low:#F3F4E9;--surface-container:#EEEFE3;--surface-container-high:#E8E9DE;--surface-container-highest:#E2E3D8;}
        .pc-wrap{font-family:'DM Sans',sans-serif;background:var(--surface-container-low);border:1.5px solid var(--outline-variant);border-radius:20px;overflow:hidden;position:relative;box-shadow:0 1px 12px rgba(26,28,22,0.07);color:var(--on-surface);}
        .pc-wrap::before{content:'';position:absolute;top:-45px;right:-45px;width:140px;height:140px;border-radius:50%;background:radial-gradient(circle,rgba(76,102,43,0.06) 0%,transparent 70%);pointer-events:none;}
        .pc-header{display:flex;align-items:center;justify-content:space-between;padding:14px 18px;border-bottom:1px solid var(--outline-variant);background:var(--surface-container);}
        .pc-header-left{display:flex;align-items:center;gap:10px;}
        .pc-icon{width:30px;height:30px;border-radius:9px;background:var(--primary-container);color:var(--on-primary-container);display:grid;place-items:center;}
        .pc-icon svg{width:14px;height:14px;}
        .pc-title{font-family:'Playfair Display',serif;font-size:1rem;font-weight:400;color:var(--on-surface);}
        .pc-badge{display:inline-flex;align-items:center;gap:5px;padding:3px 10px;border-radius:100px;background:var(--surface-container-highest);border:1px solid var(--outline-variant);font-size:11px;font-weight:500;color:var(--outline);}
        .pc-body{padding:18px 18px 20px;position:relative;z-index:1;}
        .pc-dominant{display:flex;align-items:center;gap:14px;padding:14px 16px;border-radius:14px;margin-bottom:18px;border:1.5px solid transparent;}
        .pc-dom-emoji{font-size:32px;line-height:1;flex-shrink:0;}
        ...
        .pc-bar-emoji{font-size:15px;width:22px;text-align:center;flex-shrink:0;}
        ...
        .pc-note{font-size:12px;color:var(--outline);font-weight:300;margin-top:14px;padding-top:12px;border-top:1px solid var(--outline-variant);}
        @keyframes pcIn{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}}
        .pc-wrap{animation:pcIn 0.4s ease-out both;}
      `}</style>
      <div className="pc-wrap">
        ...
        <div className="pc-body">
          {dominant && (
            ...
            >
              <span className="pc-dom-emoji">{domEmoji}</span>
              <div>
