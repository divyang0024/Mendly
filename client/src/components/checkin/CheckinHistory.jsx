              ...
              return (
                ...
                >
                  ...
                  <div className="ch-metrics">
                    ...
                    {h.sleepHours != null && (
                      <div className="ch-sleep-chip">😴 {h.sleepHours}h</div>
                    )}
                  </div>
                  {h.tags?.length > 0 && (
...
const chStyles = `
  ...
  .ch-wrap { background:var(--sl); border:1.5px solid var(--olv); border-radius:20px; overflow:hidden; font-family:'DM Sans',sans-serif; color:var(--on); position:relative; box-shadow:0 1px 12px rgba(26,28,22,.07); }
  .ch-wrap::before { content:''; position:absolute; top:-40px; right:-40px; width:120px; height:120px; border-radius:50%; background:radial-gradient(circle,rgba(56,102,99,.06) 0%,transparent 70%); pointer-events:none; }

  .ch-header { display:flex; align-items:center; justify-content:space-between; padding:14px 18px; border-bottom:1px solid var(--olv); background:var(--sm); }
  ...
  .ch-list { max-height:420px; overflow-y:auto; scrollbar-width:thin; scrollbar-color:var(--olv) transparent; }
  ...
  .ch-row {
    ...
    animation:chIn .3s ease-out both;
  ...
  .ch-sleep-chip { display:inline-flex; align-items:center; gap:4px; padding:3px 10px; border-radius:100px; background:var(--sc); color:var(--osc); font-size:11.5px; font-weight:500; flex-shrink:0; }
